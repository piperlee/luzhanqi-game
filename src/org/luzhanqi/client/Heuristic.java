...
/* 
 * Modified code from: https://code.google.com/p/gaming-platform/source/browse/trunk/eclipse/gaming-platform/src/org/gaming/shared/games/ai/Heuristic.java
 */
...
public class Heuristic {
  ...
  private static final int MIDDLEGAME = 50; // Start Middlegame tactics after 50
                                            // moves.
  ...
  public int getValueOfState(LuzhanqiState state) {
    if (state.getWinner() != null)
      return calculateGameEndedValue(state.getWinner());
    int valueOfState = 0;
  ...
  public int getValueOfPiece(Piece piece) {
    ...
    switch (piece.getFace()) {
      ...
      case BRIGADIERGENERAL:
        return 1700 * multiplier;
      case MAJORGENERAL:
        return 1800 * multiplier;
      case GENERAL:
        return 1900 * multiplier;
      case FIELDMARSHAL:
